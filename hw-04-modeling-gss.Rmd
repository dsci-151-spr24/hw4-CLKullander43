...
**I would expect a 90% confidence interval to be narrower than the other interval, because it would remove more of the outside observations, narrowing the range.**
